...
('Fish and chips med remouladsås',4,'Fisk'),
('Stekt fläsk med löksås',4,'För köttälskare'),
('Pastagratäng med rökt kassler purjolök och cocktailtomater',4,'Pasta'),
('Fish and chips med remouladsås',5,'Fisk'),
('Stekt fläsk med löksås',5,'För köttälskare'),
('Pastagratäng med rökt kassler purjolök och cocktailtomater',5,'Pasta');
