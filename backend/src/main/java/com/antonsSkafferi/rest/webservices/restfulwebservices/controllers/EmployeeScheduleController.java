...
public class EmployeeScheduleController {
    ...
    private String switchEmployeeSchedualId(@RequestParam String userone, String usertwo, int scheduleone, int scheduletwo){
        return service.switchEmployeeSchedule(userone, usertwo, scheduleone, scheduletwo);
    }
