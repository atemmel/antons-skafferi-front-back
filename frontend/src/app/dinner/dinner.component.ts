  ...
  getMenu() {
    ...
    const jsonString: any = {
      ...
      "Förrätter": { "array": [{"title": "Skagentoast", "description": "Toast med skagenröra och en citronskiva"},
        ...
        {"title": "Mozarellasticks", "description": "Friterad mozarella"}], "picture": "https://receptfavoriter.se/sites/default/files/vitloksbrod_65_980.jpg" },
      "Vilt": {"array": [{"title": "Renskav", "description": "Renskav med potatismos"},
        {"title": "Älgfilè", "description": "Älgfilè med potatisgrattäng"},
        {"title": "Bäverstek", "description": "Bäverstek med potatis"}], "picture": "https://images.ctfassets.net/wcifomac350q/74mxcPcxFKpghUOMKAGsyA/0b114891ec21bff5df58912bf7b018e5/img_viltbord_matbild.jpg?fm=webp&q=70" },
      "À La Carte": {"array": [{"title": "Lax", "description": "Lax med potatismos"},
        {"title": "Oxfilè", "description": "Oxfilè med potatisgratäng"},
        {"title": "Kötbullar", "description": "Köttbullar med potatismos med lingonsylt"}], "picture": "https://assets.icanet.se/q_auto,f_auto/imagevaultfiles/id_152536/cf_259/helstekt-oxfile-bg-1920x540.jpg?" },
      "Dryck": {"array": [{"title": "Cola", "description": "Burk(33cl)"},
        {"title": "ÖL", "description": "Stor ÖL"}], "picture": "https://www.kingsizemag.se/wp-content/uploads/2019/05/beer-ls-580x345.jpg" }
    };
